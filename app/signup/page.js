...
const SignupForm = () => {
  ...
  const handleGoogleSignup = () => {
    console.log('sign me up with Google')
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      ...
      <div className="max-w-md w-full px-6 py-8 bg-white rounded-lg shadow-md z-10 opacity-[95%] ">
        <h2 className="text-2xl font-bold text-gray-800 mb-8 mx-auto text-center">Sign up</h2>
        ...
        {/* <form onSubmit={handleSignup}> */}
          ...
          <button
            ...
            // onClick={function handleSignup(){(console.log('hey'))}}
            type="submit"
      ...
      <div className="max-w-md w-full px-6 py-4 mt-4 bg-white rounded-lg shadow-md z-10">
        <p className="text-gray-700">
          Or sign up using Google:
        </p>
        <button
          // onClick={()=>handleGoogleSignup}
          className="flex items-center justify-center w-full py-2 mt-4 bg-pink-400 hover:bg-red-600 text-white rounded-md focus:outline-none focus:bg-red-600"
        >
          <svg
